...
import (
	...
	"moby/cli/command/container"
	"moby/cli/command/image"
	"moby/cli/command/network"
	"moby/cli/command/node"
	"moby/cli/command/plugin"
	"moby/cli/command/registry"
	"moby/cli/command/secret"
	"moby/cli/command/service"
	"moby/cli/command/stack"
	"moby/cli/command/swarm"
	"moby/cli/command/system"
	"moby/cli/command/volume"
